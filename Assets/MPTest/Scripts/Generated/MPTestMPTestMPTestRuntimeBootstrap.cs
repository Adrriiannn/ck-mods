...
public sealed class MPTestMPTestMPTestRuntimeBootstrap : IMod
{
  private const string DimensionId = "MPTest:MPTest";
  private const string DimensionDisplayName = "MPTest";
  private const string ContentPackId = "MPTest:MPTestPack";
  private const string ContentPackDisplayName = "MPTest Pack";
  ...
  private const string EntryPortalId = "MPTest:MPTest.portal.entry";
  private const string ReturnPortalId = "MPTest:MPTest.portal.return";
  private const string EntryPresentationId = "MPTest:MPTest.portal.entry.presentation";
  private const string ReturnPresentationId = "MPTest:MPTest.portal.return.presentation";
  private const string PortalObjectName = "MPTest_MPTestMPTest_Portal";
  private const string ReturnPortalObjectName = "MPTest_MPTestMPTest_Portal_Return";
  private const string PortalDisplayName = "MPTest Portal";
  private const string PortalDescription = "Portal to MPTest.";
  private const string EntryFromDimensionId = "corekeeper.overworld";
  private const string EntryToDimensionId = "MPTest:MPTest";
  private const string ReturnFromDimensionId = "MPTest:MPTest";
  ...
  private const string StarterId = "MPTest:MPTest.starter";
  ...
  private void EnsureStaticRuntimeExtras()
  {
    ...
    DimensionPortalSoundRegistry.Register(
        ...
        string.Empty);
    DimensionPortalSoundRegistry.Register(
        "MPTest_MPTestMPTest_Portal_Instant",
        0,
        "AF_portal_appear",
        "AF_portal_collapse",
        "");
  ...
  private bool EnsureMinimumGenerationPasses(IDimensionService current)
  {
    if (!TryEnsureGenerationPass(
        ...
        new DimensionGenerationPassDefinition(
            "MPTest:MPTest.single-biome.terrain-pass",
            "Terrain",
            "MPTest:MPTest",
            "MPTest:StarterBiome",
            true,
