...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed class DimensionMapStagePage
    {
        ...
        private VisualElement BuildLayoutCards()
        {
            ...
            // "Ring Width" used to sit here. It was read into a variable, passed into
            // BuildRadialRingBands and never mentioned again in the body of that method: the
            // scanline algorithm that replaced the old banding writes an exact circle, so there is
            // no coarseness left to tune. The serialized field stays put, because it is part of
