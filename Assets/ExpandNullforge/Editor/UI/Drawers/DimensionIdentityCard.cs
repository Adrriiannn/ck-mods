...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static class DimensionIdentityCard
    {
            ...
            System.Action refresh)
        {
            ...
            {
                // THE HEADING COUNTS THE TICKS, not the rows. Counting every row in the
                // list, rows that cannot be ticked included, puts "2 places would be rewritten"
                // over a rename that writes one.
