...
namespace ExpandNullforge.EditorTools
{
    ...
    /// <remarks>
    /// <para>
    /// WITHOUT THESE, EVERY ONE OF THESE FIELDS IS A BLANK BOX. The stat effect a condition applies,
    /// the sound a creature makes, the puff of dust a plant throws off, the skill a talent belongs to:
    /// each is one value out of a list Core Keeper holds, and that list lives in a decompile. This is
