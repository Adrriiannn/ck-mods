...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static class DimensionsApiControls
    {
        ...
        /// <remarks>
        /// The hint is deliberately not rendered. A small grey caption beside a card's title
        /// reads as clutter, by design ruling: a card's
        /// title says what the card is, the fields inside say the rest, and anything that needs
        /// more explanation belongs on a field's own help badge. The parameter stays so the
        /// many existing call sites remain valid; it feeds the head's tooltip and nothing
        /// visible.
        /// </remarks>
        ...
        /// stage page. So this changes nothing that is drawn today, and it is not a defect being
        /// fixed: the pickers are only reached through the
