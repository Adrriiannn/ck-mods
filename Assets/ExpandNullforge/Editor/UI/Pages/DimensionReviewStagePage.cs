...
namespace ExpandNullforge.EditorTools
{
    ...
    /// </summary>
    /// <remarks>
    /// Readiness is the thing a creator is actually looking for, so it leads: a light per check,
    /// worded as a statement about the dimension rather than as the name of an internal flag — not
    /// a wall of yes and no rows. The counts sit underneath, where they answer "how big is this"
