...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed partial class DimensionPortalStagePage
    {
        ...
        /// </para>
        /// <para>
        /// IT HAS NO <c>switch (property.propertyType)</c> OF ITS OWN, and one would make these rows
        /// the one place in the studio that never asks <c>DimensionsApiControls</c> anything. The
        /// worst-served field in the tree sits here — the portal's offering, a bare box naming an
        /// item, checked by nothing — so a mark added to that field would
        /// be drawn everywhere except the page a creator actually fills it in on. Nor is the switch
        /// mirrored here: the shared control answers string, int, float and bool
        /// with four controls of its own, and answers colours, object references and
        /// vectors as well.
        /// </para>
        /// </remarks>
        ...
        /// a real edit — which on this page means an artwork rebake, a synchronous import, a
        /// refresh, and around again for ever.
        /// </remarks>
