...
namespace ExpandNullforge.EditorTools
{
    ...
    public sealed partial class DimensionFrameworkAuthoringWindow
    {
        ...
        {
            // Nothing offers it. Every stage covers all of its own content rather than falling
            // back to an original panel: Items and Gear, Mobs and Places each carry their
