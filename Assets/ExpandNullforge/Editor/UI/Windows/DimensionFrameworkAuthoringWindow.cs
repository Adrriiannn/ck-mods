...
namespace ExpandNullforge.EditorTools
{
    public sealed partial class DimensionFrameworkAuthoringWindow : EditorWindow
    {
        ...
        private DimensionPortalAppearanceStudio ResolvePortalStudioForShell()
        {
            ...
            {
                // Nothing else creates the item-portal studio: without this, switching the page to
                // the item portal resolves a null studio and shows an empty room.
                if (itemPortalAppearanceStudio == null)
                {
        ...
        private void BuildDimensionFromShell()
        {
            ...
            // explosions, fog, and the drop plan. Left to a button of its own, "Build the
            // Dimension" ships a dimension with zero content prefabs — every generator green and
            // unreachable. The manifest and bootstrap
