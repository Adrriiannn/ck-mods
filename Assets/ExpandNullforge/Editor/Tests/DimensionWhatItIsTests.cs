...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed class DimensionWhatItIsTests
    {
        ...
        /// 350 x 0.4 / 0.8 is 175. The name and the doc on this test used to say the opposite, and
        /// a green test teaching a modder to lengthen a swing for durability is worse than no test.
        ...
        /// used to delete the component whenever a second cooldown field inside the effects block
        /// was blank, which it always was.
        /// </remarks>
        [Test]
        ...
        /// </summary>
        /// <remarks>
        /// CONTRACT CHANGED. There were two cooldown fields — the item's own, and a second inside
        /// the effects block — and the effects pass runs after everything else, so the one nobody
        /// could see won: with its own field blank it destroyed the cooldown component and took the
        /// typed number with it. A melee weapon came out at the game's default 350 whatever was
        /// typed. There is one field now, and this is the test that it lands: 0.2 seconds is twice
        ...
        /// <summary>
        /// A helmet is one helmet. It used to generate as a stack of ninety of them.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// The case that used to bake int.MinValue: a typed durability AND no cooldown. The flat
        /// number took an early return that skipped the cooldown fallback, so the game's formula
        /// divided 350 by zero on the next import and rounded infinity into the sign bit — a sword
        ...
        /// <summary>
        /// The placement check used to exempt Pet and Food from the rule it printed. The game routes
