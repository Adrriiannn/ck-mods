...
namespace ExpandNullforge.EditorTools
{
    ...
    /// </summary>
    /// <remarks>
    /// The world builds terrain from the FIRST entry of each list. Nothing on the page said so, and
    /// a new biome used to arrive pre-filled with ids no block could ever produce — so the resolver
    /// and its messages are the half of the feature a creator actually meets.
    /// </remarks>
    internal sealed class DimensionBiomeTerrainMaterialTests
    {
        ...
        /// export blocker here would stop every project still carrying the placeholder ids the
        /// framework itself used to write into a new biome.
        /// </summary>
        [Test]
