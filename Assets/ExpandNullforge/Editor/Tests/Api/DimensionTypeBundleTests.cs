...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed class DimensionTypeBundleTests
    {
        ...
        {
            // The footgun this closes: checking by SPACE KIND lets a dimension claiming the
            // Overworld kind skip conflict checking, so later allocations stack on top of it. The
            // check is by ID, and no custom dimension can wear the Overworld's id.
