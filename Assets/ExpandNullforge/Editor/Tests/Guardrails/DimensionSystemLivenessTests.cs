...
namespace ExpandNullforge.EditorTests
{
    ...
    /// <remarks>
    /// <para>
    /// EXPLICIT CREATION IS THE WRONG QUESTION. Reading the mod entry
    /// point's source text and checking that each system's name appears in a
    /// <c>GetOrCreateSystemManaged&lt;T&gt;</c> call rests on the premise that "explicit creation
