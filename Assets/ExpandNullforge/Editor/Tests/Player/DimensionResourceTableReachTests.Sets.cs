...
namespace ExpandNullforge.EditorTests
{
    ...
    public sealed partial class DimensionResourceTableReachTests
    {
        ...
        /// </summary>
        /// <remarks>
        /// A strip that removes every row carrying a set number this framework has handed out is
        /// not safe for another mod, however it reads.
        ...
        /// written at the same number after ours, is deleted by our next append.
        /// </remarks>
        [Test]
        ...
        /// </summary>
        /// <remarks>
        /// The strip must not sit behind an early return on an empty row list, nor the patch behind
        /// an earlier one on "nothing is registered": the one load that has nothing to append is
        /// then the one load that cannot clean up. A creator who unticks "Add sets" keeps them, in a
        /// table nothing in the registry can still explain.
        /// </remarks>
        [Test]
