...
namespace ExpandNullforge.EditorTools
{
    ...
    /// <remarks>
    /// <para>
    /// ONE OF THE TWO IS LIVE AND THE OTHER IS NOT, AND THE DIFFERENCE IS RECORDED HERE. A dotted
    /// card path puts its whole block back in
    /// the catch-all fold, so twenty-two values get two live editors on one page: measured on the
