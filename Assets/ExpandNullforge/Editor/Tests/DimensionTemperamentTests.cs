...
namespace ExpandNullforge.EditorTests
{
    ...
    public sealed class DimensionTemperamentTests
    {
        ...
        /// </summary>
        /// <remarks>
        /// The generator used to warn here and move on, which meant the two commonest tempers
        /// shipped a creature with no <c>ChaseStateAuthoring</c> — and with none,
        /// <c>ChaseStateRequest.ShouldUpdate</c> returns false forever, so the creature could only
        /// ever swing at whatever was already touching it.
        /// </remarks>
        [Test]
        ...
        /// </summary>
        /// <remarks>
        /// THIS USED TO PIN THE OPPOSITE, and the opposite was a creature that had quietly left the
        /// game. The component was taken off entirely when the temper was Custom and both lists
        /// were empty. But its presence is a hard gate on the chase and on every attack —
        ...
        /// <summary>
        /// Every temper reaches a boss, which the generator used to refuse.
        /// </summary>
        /// <remarks>
        /// Bosses were pinned to Hostile with a comment claiming a boss has no temperament
        /// question. A boss that sleeps in its arena until you swing first is a real shape and the
        /// framework was building it as an ordinary aggressive boss instead. Nothing in
