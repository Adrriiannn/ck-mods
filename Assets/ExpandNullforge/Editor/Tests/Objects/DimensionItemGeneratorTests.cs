...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed class DimensionItemGeneratorTests
    {
        ...
        public void Weapon_CarriesDamageValueAndADurabilityComponent()
        {
            ...
            // NO WARNING IS EXPECTED HERE, deliberately. An authored durability goes unbaked only
            // when the object goes out typed NonUsable, which matches no case in the game's
            // formula, so the formula returns the initialAmount of 1 it was handed. With the item
