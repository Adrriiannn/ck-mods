...
namespace ExpandNullforge.EditorTests
{
    ...
    public sealed partial class DimensionEmittedLightTests
    {
        ...
        /// </summary>
        /// <remarks>
        /// The light lives in the prefab a player walks up to, and writing that prefab
        /// only for an object with a picture or something that uses it drops a lit alcove's light
        /// along with the file.
        /// </remarks>
        [Test]
