...
namespace ExpandNullforge.EditorTests
{
    ...
    /// vehicle, none of which comes for free: it is an object they can own; it can be put down
    ...
    public sealed class DimensionVehicleTests
    {
        ...
        {
            // The single measurement behind this: a vehicle that is NonObtainable with no
            // placement is one no player can ever hold. All seven vanilla vehicles are
        ...
        {
            // A vehicle with no slot for a name to appear in gets a warning instead of a row. This
            // one has a slot, so it is named like every other placeable.
