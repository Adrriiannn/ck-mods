...
namespace ExpandNullforge.EditorTools
{
    ...
    /// </summary>
    /// <remarks>
    /// This coverage exists because the policy used to be authored and then thrown away —
    /// mode, radial band, weight, unique and required reached nothing at runtime, and
    /// <c>DimensionScenePlacement.TryPlace</c> had zero callers. These tests lock the repair
    /// in place: the pool must carry every field, and the provider must be reachable from
