...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed class DimensionSlotAllocatorTests
    {
        ...
        [Test]
        public void Allocate_FirstAutomaticSlotIsNorthAtFiveThousand()
        {
            ...
            Assert.That(result.AbsoluteOrigin, Is.EqualTo(new int2(5000, 0)));
        ...
        {
            DimensionSlotRecord north = Occupy("dim-north", new int2(5000, 0));
            DimensionSlotRecord northEast = Occupy("dim-ne", new int2(5000, 5000));

            // North taken -> next candidate is north-east.
            ...
            // North and north-east taken -> next candidate is east.
            DimensionSlotAllocationResult afterNorthEast = DimensionSlotAllocator.Allocate(
                AutoRequest("dim-c"),
                null,
                new[] { north, northEast });
            Assert.That(afterNorthEast.AbsoluteOrigin, Is.EqualTo(new int2(0, 5000)), afterNorthEast.Message);
        }
