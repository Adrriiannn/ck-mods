...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static class DimensionCritterGenerator
    {
            ...
            string outputFolder)
        {
            ...
            {
                // A biome-homed critter used to get an EMPTY biome list — spawnType said
                // Biome, the list said nowhere, and the critter was authored, warned-clean
                // and absent. Vanilla biome names bind the game's values; the mod's own
                // biomes bind the same minted ints the biome sampler reports.
        ...
        /// <remarks>
        /// <para>
        /// Set beside <c>CritterLarvaEntity</c>, a generated critter used to be missing its whole
        /// state machine, its health, its scatter, its gravity, its perception, its despawn and its
        /// placeability — so it could not move, could not be hurt, could not die, could not despawn
        /// and could not be put back down after being caught. This file's own opening remark named
        /// scatter as the thing that makes a critter feel alive, and no line added it.
        /// </para>
        /// <para>
