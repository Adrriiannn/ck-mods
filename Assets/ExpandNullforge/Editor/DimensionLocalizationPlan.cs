...
namespace ExpandNullforge.EditorTools
{
    ...
    /// crops do. Vehicles USED to be on this list and no longer are — they are placeable, obtainable
    /// objects now, so they are named like every other one.
    /// </para>
    /// </remarks>
    internal sealed class DimensionLocalizationPlan
    {
        ...
        /// </summary>
        /// <remarks>
        /// This used to be a warning saying no row could be written, because a generated vehicle was
        /// built as an object nobody could pick up or put down and so had no slot for a name to appear
        /// in. A vehicle is now <c>ObjectType.PlaceablePrefab</c> with an icon and placement, exactly
        /// as the game's own Boat and Minecart are, so it has the same two places for a name as every
        /// other placeable and is named the same way.
        /// </remarks>
