...
namespace ExpandNullforge.Authoring
{
    ...
    public static class DimensionTemplateCustomizerFieldOptionCatalogUtility
    {
            ...
            DimensionTemplateCustomizerField field)
        {
            ...
            {
                // The template-asset layer behind this id was removed; the id remains a plain
                // string, so the picker offers only "leave it empty" and the typed value.
                hasFixedOptions = true;
                AddEmptyOption(
                    options,
                    field,
                    "None",
                    "Leave the biome without an environment profile id.",
                    0);
            ...
            else if (field.FieldId == "palette-id")
            {
                ...
                AddEmptyOption(
                    ...
                    field,
                    "None",
                    "Leave the biome without a palette id.",
                    0);
