    ...
    public static class DimensionFrameworkToolGuideUtility
    {
        public static DimensionFrameworkToolGuide Build(DimensionTemplateAuthoringWorkspace workspace)
        {
            ...
            AddModule(
                ...
                "Choose placed portals, inventory-use items, generated entrances, return anchors, recipes, unlocks, cooldowns, and failure feedback.",
            ...
            AddModule(
                ...
                "Pick a layout preset or custom mask, then preview bounds, biome ownership, coordinate shells, and placement conflicts.",
            ...
            AddModule(
                ...
                "Each biome wants terrain, walls, liquids, destructibility, density, fog, lighting, ambience, music, palettes, and generation rules.",
            ...
            AddModule(
                ...
                "It takes enemy tables, passive animals, boss triggers, summoning items, NPC conditions, encounter zones, drops, sounds, arenas, and multiplayer-safe state.",
            ...
            AddModule(
                ...
                "Recipes, quantities, vanilla or custom workbenches, category icons, tabs, unlock conditions, craftability flags, and generated-only exceptions.",
            ...
            AddModule(
                ...
                "Dry-run validation covers generation passes, weighted tables, provider budgets, exact placements, overlaps, invalid assets, missing providers, and heavy rules.",
            ...
            DimensionTemplateStarterAssessment assessment)
        {
            ...
            return assessment != null && assessment.HasGenerationPass
                ? DimensionAuthoringReadinessState.Ready
                : DimensionAuthoringReadinessState.Partial;
        }
            ...
            DimensionTemplateStarterAssessment assessment)
        {
            ...
            if (biomeCount == 0)
            {
                return "Create at least one biome.";
            }

            if (assessment == null || !assessment.HasGenerationPass)
            {
                return "Finish generation passes for each authored biome.";
            }
        ...
        private static DimensionAuthoringReadinessState ResolveSpawnsState(
            DimensionTemplateManifestExportPreview preview)
        {
            return preview.AuthoredSpawnableContentCount > 0
                ? DimensionAuthoringReadinessState.Ready
                : DimensionAuthoringReadinessState.Partial;
        }
        ...
        private static DimensionAuthoringReadinessState ResolveResourcesState(
            DimensionTemplateManifestExportPreview preview)
        {
            return preview.AuthoredResourceContentCount > 0
                ? DimensionAuthoringReadinessState.Ready
                : DimensionAuthoringReadinessState.Partial;
        }
            ...
            IReadOnlyList<DimensionFrameworkToolModule> modules)
        {
            ...
            string message = state == DimensionAuthoringReadinessState.Ready
                ? "Every stage of the selected dimension is ready."
                : state == DimensionAuthoringReadinessState.Blocked
