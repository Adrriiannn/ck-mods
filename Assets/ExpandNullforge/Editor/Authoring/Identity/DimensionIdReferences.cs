...
namespace ExpandNullforge.EditorTools
{
    ...
    /// asset, and <see cref="FindHolders"/> is for those. With only the string sweep, a loot table
    /// three monsters drop answers "Nothing uses this yet".
    /// </para>
    /// <para>
    ...
    internal static class DimensionIdReferences
    {
        ...
        /// </para>
        /// <para>
        /// <c>blockName</c> IS DELIBERATELY NOT ON IT. It is a block's own identity and nothing
        /// points at a block by it — both true, and both an argument for listing it — but a field on
