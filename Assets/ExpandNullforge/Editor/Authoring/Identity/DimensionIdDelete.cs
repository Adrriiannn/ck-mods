...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static class DimensionIdDelete
    {
            ...
            bool alsoOutsideThisPack)
        {
            ...
            // nothing in this framework validates for one. Without this sweep the dialogue says
            // "Nothing points at it." over three of them.
            plan.Edges.AddRange(
            ...
            out string report)
        {
            ...
            // ONE UNDO GROUP FOR EVERYTHING UNDO CAN REACH, the list removal included. Closing the
            // group before the asset is taken out of the dimension's own array makes the first
            ...
            // is then needed to get the pointers back. What Ctrl+Z cannot do either way is bring
            // the file back, and the report below says so rather than leaving it to be discovered.
        ...
        /// leaves them unticked; delete has no ticks, so handing the whole list to the clear would
        /// make "Delete it and empty them" quietly empty fields in another modder's pack. They are
