...
namespace ExpandNullforge.EditorTools
{
    ...
    /// </para>
    /// <para>
    /// The blast does NOT carry damage numbers of its own. It used to, and they were a lie: every
    ...
    internal static class DimensionExplosiveBlast
    {
        ...
        /// RequireComponent blocks it. It used to destroy the component outright: harmless while
        /// nothing here was ever required by anything, and a silent stale value the first time one
        /// was — which is the shape of bug this framework keeps finding.
        /// </remarks>
