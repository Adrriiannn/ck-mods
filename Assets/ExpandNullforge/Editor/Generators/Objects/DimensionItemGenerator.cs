...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionItemGenerator
    {
            ...
            Dictionary<string, DimensionCookingTemplate> ingredientsById)
        {
            ...
            //
            // A WRITTEN DURABILITY THAT "READS BACK AS 1" HAS NOT BEEN THROWN AWAY. DurabilityAuthoring
            // recomputes durability on prefab import from the object's OWN type and initialAmount,
            // so both have to be right: an unwritten type is the enum default, which matches no case
            // in the game's formula, and a hardcoded initialAmount of 1 is what the formula then
            // returns unchanged. That is the whole of the 1. With the type written, the same formula
