...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionItemGenerator
    {
            ...
            DimensionItemGenerationReport report)
        {
            ...
            // Written for every item, not only the world-placed ones. "If it is placed in the world,
            // say PlaceablePrefab" leaves everything a player holds at the enum's own default of
            // NonUsable — and NonUsable is the value the game maps to the non-usable slot, so a
            // generated sword could not be swung and a generated helmet could not be worn.
            ...
            // mod creature standing in slime is not in the system at all without it.
            // (PlayerAttackRoutineSystem is not a fourth, though it reads like one: it reads
