...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionObjectSpine
    {
            ...
            bool theTierMayBeAdded = true)
        {
            ...
            // THE TIER IS NOT SAFE TO ADD, so this pass only adds it when told it may.
            // AreaLevelAuthoring is the level trap: with it present, MeleeAttackStateAuthoring
            // .OnValidate recomputes attack damage from the curve and offers no way out. A creature
            // whose stats are set to "the numbers you typed are kept exactly" has ApplyAreaLevel
            // take the component off during its state machine — and this pass runs four hundred
            // lines later, on the same object, in the same generate, where adding it unasked puts
            // it straight back on.
            //
