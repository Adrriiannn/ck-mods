...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionObjectSpine
    {
            ...
            System.Func<string, bool> isDeferred = null)
        {
            ...
            {
                // The fuse goes too. An item the last generate made a bomb and this one does not
                // would otherwise keep its countdown and quietly delete itself a few seconds after
                // being placed, which reads as the item being broken rather than as a leftover.
