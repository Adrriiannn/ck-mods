...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionObjectSpine
    {
            ...
            where T : Component
        {
            ...
            {
                // A BLOCKED REMOVAL IS SAID OUT LOUD. Every caller discards this answer, so a
                // silent one leaves the component on the object carrying the PREVIOUS generate's
                // fields with nothing said anywhere — the same shape as the stale-flag bugs this
                // framework keeps finding, reached by a different road. It is said here because
                // saying it at every one of the several hundred call sites is not something a
                // person would keep up.
                Debug.LogWarning(
