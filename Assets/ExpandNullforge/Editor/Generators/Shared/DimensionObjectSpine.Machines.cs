...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionObjectSpine
    {
        ...
        /// that block claimed. This pass runs second, so its removals cannot be unconditional:
        /// unconditional, an object that reacts to a nearby lantern with no gate authored at all
        /// has its reaction taken straight back off, silently. It removes only what nothing else
