...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionWorldObjectGenerator
    {
            ...
            DimensionWorldObjectGenerationReport report)
        {
            ...
            switch (worldObject.Kind)
            {
                case DimensionWorldObjectKind.Door:
                {
                    ...
                    // is ObjectDataCD + PhysicsCollider + ColliderVariationCD. Every placed object
                    // this framework writes carries a PhysicsCollider, so a generated door matches
                    // that query.
                    //
                    // IT IS NOT A CRASH. Every generated object says its look is not
            ...
            DimensionNamingContext naming)
        {
            ...
            // something nearby has its reaction removed here, one call later, in silence.
