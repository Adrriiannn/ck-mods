    ...
    internal static partial class DimensionWorldObjectGenerator
    {
            ...
            DimensionWorldObjectGenerationReport report)
        {
            if (worldObject.CannotBeAttacked)
            {
                ...
                // natural setting for every one of those, and switching them all off is what a
                // narrower reading of "unbreakable" would do.
            ...
            DimensionWorldObjectGenerationReport report)
        {
            ...
            // prefab it wrote last time, so below the return, deleting every drop off this object
            // leaves last time's drops baked on it with no way to take them off, and a renamed mod
            // leaves it pointing at a loot table minted from the old name that nothing ever fills.
