...
namespace ExpandNullforge.EditorTools
{
    ...
    internal static partial class DimensionRuntimeConsumerBootstrapUtility
    {
            ...
            bool itemPortal)
        {
            ...
            // THE WHOLE BODY OF THIS METHOD LIVES IN DimensionEmittedLightBuilder.Ensure
            ...
            // range, and returning null for a light that is switched off — so that a placed object
            // authored with a light gets the same subtree the portal does rather than a second
            // implementation of it. The portal's own numbers are read from its visual profile here.
