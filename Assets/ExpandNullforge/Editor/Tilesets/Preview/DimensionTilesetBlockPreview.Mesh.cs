...
namespace ExpandNullforge.EditorTools
{
    ...
    internal sealed partial class DimensionTilesetBlockPreview
    {
        ...
        ///
        /// SEAM FIX: the UVs are the raw captured rect, NOT full edge-to-edge 16px cell UVs
        /// reconstructed from the cell's pixel
        /// origin. Vanilla samples with its captured ~15.75px rects, inset ~0.125px per side
        /// (the game's anti-bleed gutter). With full-cell UVs, the outermost samples' bilinear/point
        /// footprints reach into the NEIGHBOURING sheet cell (often black wall interior), which draws
        /// thin dark seam lines between adjacent tiles — vertical hairlines down N-S wall columns and
        /// a horizontal line across the ground — made chunky by the point-upscaled low-res RT. The
        /// raw captured rect keeps every sample ≥ 0.125px inside its cell, so no cross-cell bleed
