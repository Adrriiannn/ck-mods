...
namespace ExpandNullforge.EditorTools.Generation
{
    ...
    /// <remarks>
    /// <para>
    /// WHY THIS EXISTS. Without it, ticking "glows in the dark" hands the modder an empty texture
    /// field. The sheet they then have to supply must match the tileset sheet pixel for pixel — same size, same
