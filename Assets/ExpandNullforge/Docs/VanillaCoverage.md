...
> the partials of `Editor/Generators/Shared/DimensionObjectSpine` rather than repeated per
> generator. The trunk declares the type and writes almost nothing; each of these has one partial
> that owns it.
>
