...
{
    // The prop, loot-container and spawn-point templates that used to live beside this class were
    // the pre-CustomSceneBlob plan for scene furniture. Placed objects, chest contents and fixed
    // creatures all travel through DimensionSceneObjectTemplate now, and ambient population is the
    // per-creature spawn chain, so those templates were removed rather than left as settings that
    // did nothing.
