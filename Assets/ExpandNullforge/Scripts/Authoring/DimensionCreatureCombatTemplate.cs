...
namespace ExpandNullforge.Authoring
{
    ...
    public sealed class DimensionCreatureCombatTemplate
    {
        ...
        // fill, and evolving counts the meals. The list used to be shipped empty with no way to
        // fill it, so the eat, breed and evolve answers generated cleanly and never once fired.
        ...
        // ---- Answers that used to be written only for things a player PLACES -------------------
        //
        // Every one of the eight below is a template the framework has been able to write for a
        // long time, from a method the creature generator simply never called: the world-object
        // generator was the only caller of each. So a beam, a healing aura, mana, an owner, hiding
        // in bushes, roaming a circuit, hurting whatever comes near, and a shop were all buildable
        // and none of them was reachable from a creature — which is where nearly all of them
        // belong. Nesting them here rather than on the mob asset is what reaches mobs, animals and
