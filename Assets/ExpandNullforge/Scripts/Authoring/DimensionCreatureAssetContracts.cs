namespace ExpandNullforge.Authoring
{
    ...
    /// all of them. They do share this, and validation needs to read it across all four. It used to
    /// do that with <c>Type.GetField</c>, which the mod sandbox refuses; naming the shape they
