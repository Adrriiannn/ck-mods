...
namespace ExpandNullforge.Authoring
{
    ...
    public static class DimensionTemplateCustomizerFieldModelUtility
    {
            ...
            DimensionTemplateStarterGraph graph)
        {
            ...
            AddCountField(fields, "environment-profiles", "Environment Profiles", dimension.EnvironmentProfiles.Length, 120);
            AddCountField(fields, "global-scenes", "Global Scenes", dimension.GlobalScenes.Length, 130);
            AddCountField(fields, "global-resource-nodes", "Global Resource Nodes", dimension.GlobalResourceNodes.Length, 140);
            ...
            AddCountField(fields, "global-spawn-rules", "Global Spawn Rules", dimension.GlobalSpawnRules.Length, 230);
            AddCountField(fields, "global-generation-passes", "Global Generation Passes", dimension.GlobalGenerationPasses.Length, 240);
            AddCountField(fields, "global-generation-tables", "Global Generation Tables", dimension.GlobalGenerationTables.Length, 250);
            ...
            BiomeTemplateAsset biome)
        {
            ...
            AddTextField(fields, "environment-profile-id", "Environment Profile", biome.ResolvedEnvironmentProfileId, 60);
            AddTextField(fields, "palette-id", "Palette", biome.ResolvedPaletteAssetId, 70);
            AddReferenceField(fields, "generation-profile", "Generation Profile", biome.GenerationProfile != null, 80);
            AddCountField(fields, "content-presets", "Content Presets", biome.ContentPresets.Length, 90);
            AddCountField(fields, "scene-pool", "Scene Pool", biome.ScenePool.Length, 100);
            AddCountField(fields, "resource-nodes", "Resource Nodes", biome.ResourceNodes.Length, 110);
            AddCountField(fields, "spawn-rules", "Spawn Rules", biome.SpawnRules.Length, 120);
            AddCountField(fields, "generation-passes", "Generation Passes", biome.GetGenerationPassesWithProfile().Length, 130);
            AddCountField(fields, "generation-tables", "Generation Tables", biome.GetGenerationTablesWithProfile().Length, 140);
            AddCountField(fields, "floor-objects", "Semantic Floor Objects", biome.GetFloorObjectIdsWithPresets().Length, 150);
            AddCountField(fields, "wall-objects", "Semantic Wall Objects", biome.GetWallObjectIdsWithPresets().Length, 160);
            AddCountField(fields, "ore-objects", "Semantic Ore Objects", biome.GetOreObjectIdsWithPresets().Length, 170);
            AddCountField(fields, "water-objects", "Semantic Water Objects", biome.GetWaterObjectIdsWithPresets().Length, 180);
