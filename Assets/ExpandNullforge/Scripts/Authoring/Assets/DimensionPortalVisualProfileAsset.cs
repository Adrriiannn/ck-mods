...
#pragma warning restore 0414
        ...
        /// </summary>
        /// <remarks>
        /// Worked out from the two flicker numbers rather than authored on its own. The game's
        /// LightFlickerEffect overwrites a light's intensity with the midpoint of its range the
        /// moment it wakes, so a separately authored number could only ever be replaced. There used
        /// to be a field here offering exactly that, which is why the studio's reset no longer
        /// writes one.
        /// </remarks>
