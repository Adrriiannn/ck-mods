...
namespace ExpandNullforge.Authoring
{
    ...
    public sealed class DimensionCreatureStatsTemplate
    {
        ...
        /// </para>
        /// <para>
        /// A LEVEL-SCALED PARENT KEEPS ITS CURVE. Turning one into fixed numbers used to resolve
        /// the parent's health as if it were level 1 and multiply that — which made the elite of a
        /// deep-biome creature WEAKER than the creature it was supposed to be a harder copy of, and
        /// dropped its <c>AreaLevelAuthoring</c> so its attack damage stopped scaling too. The
        /// level-scaled path now stays level-scaled, and the elite's extra strength rides on the
