...
{
  // The deterministic seed service. This used to live in the generation-table partial; the
  // tables were removed (nothing ever consumed an authored table's entries), but the seeds
  // are consumed by generation providers and stay — so the implementation moved here rather
  // than dying with its old neighbour.
