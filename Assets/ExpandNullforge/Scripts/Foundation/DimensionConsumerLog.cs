namespace ExpandNullforge.Foundation
{
    ...
    /// compiled into the consumer's own assembly, so nothing internal to this one is in reach. Two
    /// lines of the emitter used to write <c>Debug.LogWarning</c> as text straight into that file,
    /// which meant every mod ever built with this framework shipped ungated raw logging with a
    /// prefix of its own — and a player with three such mods installed got three different prefixes
