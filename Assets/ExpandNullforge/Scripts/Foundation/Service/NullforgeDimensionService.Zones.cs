...
namespace ExpandNullforge.Foundation
{
  public sealed partial class NullforgeDimensionService
  {
    ...
    /// </para>
    /// <para>
    /// This lives HERE, at the bottom of registration, rather than at the manifest-apply call
    /// site. Zones created by the generated bootstrap's minimum-zone path never
    /// go through that call site, so a dimension that never applies a content manifest would bind
    /// nothing and both gates would stay inert for it. Every path that can put a zone in the catalog
