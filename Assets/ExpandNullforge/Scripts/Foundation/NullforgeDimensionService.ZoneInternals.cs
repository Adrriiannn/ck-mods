...
{
  // Zone validation and ordering. These used to live beside the environment-profile internals;
  // the profile store was removed (nothing rendered from it), but zones are live, so their
  // helpers moved here rather than dying with their old neighbour.
