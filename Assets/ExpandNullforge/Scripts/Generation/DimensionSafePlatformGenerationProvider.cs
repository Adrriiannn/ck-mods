...
namespace ExpandNullforge.Generation
{
  ...
  {
    // Dirt, and only when nothing says otherwise. This is the ONLY tileset this file names, and
    // while it was also the only one this file USED, every generated dimension came out a dirt
    // platform however carefully its biomes were authored. DimensionTerrainMaterialRegistry
    // answers first now; this is what a cell no biome covers gets, so an unauthored dimension
    // still generates a dirt platform.
